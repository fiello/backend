 ...
 *  \details   Holds declaration of the Log class and additional enum with acceptable log levels
 *  \author    Dmitry Sinelnikov
 *  \date      2012
 */

#ifndef CS_LOGGER_LOG_H
#define CS_LOGGER_LOG_H
...
/**
 *  \class     cs::logger::Log
 *  \brief     Class to provide some common interface for easy logging
 *  \details   Class is non-copyable and should be used as a temporary object
 *             on a stack, as logging is produced in class destructor
 */
...
public:
   ...
   /**
    * Destructor. Print accumulated log level to the stdout / err streams
    * and to the log file with hardcoded name
    */
   ~Log();
...
/**
 *  \namespace cs::logger
 *  \brief     Holds implementation of the logger functionality (Log class)
 */

#endif // CS_LOGGER_LOG_H
